...
namespace Vegan.Web.Controllers
{
    public class TestProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Price,Title,ImageURL")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Price,Title,ImageURL")] Product product)
        {
            if (ModelState.IsValid)
            {
